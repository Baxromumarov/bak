...
var builtinContractsByID = map[BuiltinID]BuiltinContract{
	...
	BUILTIN_IS_SOME: fixedArity("is_some", 1),
	BUILTIN_IS_NONE: fixedArity("is_none", 1),
	...
	BUILTIN_SOCKET_CONNECT_TLS: {
		...
		MaxArgs:        2,
		CheckArgTypes:  true,
		PermissionOp:   "socket.connect_tls",
		PermissionFlag: runtimecap.FlagAllowNet,
	},
	BUILTIN_SOCKET_SET_TIMEOUT: {
		...
		MaxArgs:        2,
		CheckArgTypes:  true,
		PermissionOp:   "socket.set_timeout",
		PermissionFlag: runtimecap.FlagAllowNet,
	},
	BUILTIN_SOCKET_BIND: {
	...
	BUILTIN_IS_OK:      fixedArity("is_ok", 1),
	BUILTIN_IS_ERR:     fixedArity("is_err", 1),
	BUILTIN_UNWRAP_ERR: fixedArity("unwrap_err", 1),
